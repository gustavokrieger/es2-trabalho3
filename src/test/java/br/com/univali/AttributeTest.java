...
class AttributeTest {
  ...
  void testScoreLowerThanMinimum() {
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> Attribute.fromScore(-1));
  ...
  void testScoreHigherThanMaximum() {
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> Attribute.fromScore(101));
    assertEquals("Value needs to be at least 0 and at most 100", exception.getMessage());
  }
  ...
  void testHeightLowerThanMinimum() {
    Exception exception =
        assertThrows(IllegalArgumentException.class, () -> Attribute.fromHeight(-1));
